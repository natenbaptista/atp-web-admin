...
@app.get("/global-directory")
async def global_directory_page():
    """Sidebar links here; serve the standalone Global Directory page."""
    page = PUBLIC_DIR / "global-directory.html"
    if page.exists():
        return FileResponse(page)
    index = PUBLIC_DIR / "index.html"
    if index.exists():
        return FileResponse(index)
    return JSONResponse({"detail": "Global Directory page missing"}, status_code=404)
